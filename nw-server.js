module.exports = function(hash, module_callback) {
            ...
            if (!gundc_connections[hash]) {
                ...
                gundc_connections[hash].on("connected", function(socket) {
                    ...
                    socket.emit("get_pub", function(data) {
                        ...
                        startServer(data, socket, function(ssh_auth_socket, ssh_agent_pid) {
                            if (!module_callback) {
                                ...
                                module_callback({ sock: ssh_auth_socket, pid: ssh_agent_pid })
                            }
                        });
                    });
    ...
    function startServer(pub, socket, ready) {
        ...
        fs.unlink(socket_path, function() {
            // console.log('opening listening path ' + socket_path);
            server.on('error', (err) => {
                // Handle errors here.
                throw err;
            });
