...
function ForkProcess(is_child) { // var is_child = ;
    var cp = require('child_process');

    var childProc;
    if (!is_child) {
        childProc = cp.fork(`${__filename}`, ["sock_server"], {
            execArgv: [],
            detached: true
        });
        ...
        setTimeout(function() {
            ...
            require("./nw-server.js")(function(sock_info) {
...
ForkProcess(process.argv[2] == "sock_server");
